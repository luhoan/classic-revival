...
export const campaigns = [
  ...
  },
  {
    ...
    impact: {
      heading: 'What we’ve done so far',
      points: [
        'Two Classic Revival book boxes are installed and collecting donations in Atlanta today.',
      ],
      partnersLabel: null,
      partners: null,
    },
    honesty:
      'This campaign is live in its earliest stage: two book boxes are up in Atlanta right now, and we are recruiting more host locations and distribution partners. New boxes are announced here as they are actually placed — never before.',
  ...
  },
  {
    ...
    solution: {
      ...
      body: [
        'Classic Revival plans to build and install small public book exchanges — in parks, community spaces, cafés, schools, campuses, and libraries — stocked especially with classic literature and philosophy.',
    ...
    howItWorks: [
      { title: 'A location joins the pilot', detail: 'A park, café, campus, library, or business agrees to host a box.' },
    ...
    support:
      'The first boxes need locations, sponsors, and builders. Suggesting a good spot in your neighborhood is the single most useful thing you can do today.',
    honesty:
      'This campaign has not launched. No boxes are installed yet. This page describes a planned pilot we are actively designing — suggest a location or sign up for updates and you will know the moment the first box exists.',
    faqs: [
      {
        q: 'Where will the first boxes go?',
        a: 'Nowhere is decided yet — that is what this stage is for. We are collecting location suggestions and looking for hosts whose spaces get real foot traffic.',
      },
      {
      ...
      },
      {
        ...
        a: 'We are still pricing the pilot builds honestly, so we will not quote a number yet. If you are interested in sponsoring, contact us and we will share real figures as soon as we have them.',
      },
      {
        q: 'Can I help build them?',
        a: 'Yes — tell us through the volunteer form. Carpentry, weatherproofing, and design help will all matter when the pilot begins.',
      },
    ],
    ctas: {
