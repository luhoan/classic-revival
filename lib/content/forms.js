...
export const forms = {
  ...
  'essay-competition': {
    ...
    standalone: true,
    intro:
      'Sign up for the Classic Revival essay competition. If your essay is already written, paste the link to your Google Doc below — that counts as your submission.',
    fields: [
      ...
      { name: 'essayTitle', label: 'Essay title', type: 'text', required: false, help: 'If you already have one — you can decide later.' },
      {
        name: 'docLink',
