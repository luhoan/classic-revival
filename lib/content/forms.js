...
export const forms = {
  ...
  'essay-competition': {
    ...
    title: '2026 Essay Competition Entry',
    shortLabel: 'Enter the essay competition',
    // Rendered on its own page (/essay-competition), not under /get-involved.
    standalone: true,
    intro:
      'Enter the 2026 Essay Competition here. Put your finished essay in a Google Doc, set sharing to “Anyone with the link can view,” and submit the link with your details below.',
    fields: [
      { name: 'name', label: 'Full name', type: 'text', required: true, autoComplete: 'name' },
      { name: 'email', label: 'Email', type: 'email', required: true, autoComplete: 'email' },
      { name: 'grade', label: 'Grade', type: 'text', required: true, placeholder: 'e.g. 8th grade, or the international equivalent' },
      { name: 'school', label: 'School', type: 'text', required: true, placeholder: 'Or “Homeschool”' },
      { name: 'cityCountry', label: 'City and country', type: 'text', required: true, placeholder: 'e.g. Atlanta, United States' },
      {
        name: 'parentContact',
        label: 'Parent or guardian contact',
        type: 'text',
        required: false,
        help: 'Name and email, if required for your entry.',
      },
      { name: 'essayTitle', label: 'Essay title', type: 'text', required: true },
      {
        name: 'essayLink',
        label: 'Link to your essay',
        type: 'url',
        required: true,
        placeholder: 'https://docs.google.com/…',
        help: 'A Google Doc set to “Anyone with the link can view.”',
      },
    ],
    success:
      'Your entry is in. Winners will be contacted by email and announced by November 1, 2026.',
  },
}
