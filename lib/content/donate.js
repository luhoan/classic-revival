...
export const donation = {
  ...
  ways: [
    ...
    {
      id: 'public-exchange',
      title: 'Back the public book exchanges',
      description:
        'The first take-one, leave-one boxes are already at a public library, stocked with their first books. Sponsors put the next ones in parks, cafés, and campuses.',
      suggestedAmount: null,
    },
  ],
