...
export const site = {
  ...
  metrics: [
    ...
    { id: 'boxes-installed', label: 'Book boxes installed', value: 5 },
  ...
  buildingNext: [
    ...
    'Adding community book-donation boxes beyond our first five locations.',
    'Expanding our public take-one, leave-one book exchanges beyond the first library placement.',
  ],
}
