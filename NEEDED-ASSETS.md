...
- [x] The second Atlanta donation box (`public/photos/donation-box-atlanta-2.jpg`) and books from the boxes donated to the Sandy Springs Library (`public/photos/sandy-springs-library-books.jpg`) — both shown on the home page, About, Our Work, and the Photos page (`/photos`)
- A social-sharing image (1200×630) at `public/og-image.png`

## Facts & records (unlock hidden sections)
- [x] First verified impact numbers — $1,000+ donated, 3+ partner schools, 5 book boxes installed (update `lib/content/site.js` as they grow)
